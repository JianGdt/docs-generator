        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center px-4 py-2 border border-slate-700 rounded-lg shadow-sm bg-slate-900 text-slate-300 hover:bg-slate-800 transition-colors disabled:opacity-50"
            >
